[assembly: TestFramework(
    "WorkTool.Core.XUnitTests.TestFrameworks.AvaloniaUiTestFramework",
    "WorkTool.Core.XUnitTests"
)]
...
namespace WorkTool.Core.XUnitTests.TestFrameworks;
    ...
    private class Runner : XunitTestAssemblyRunner
    {
        ...
        protected override void SetupSyncContext(int maxParallelThreads)
        {
            ...
            var thread = new Thread(() =>
            {
                try
                {
                    AvaloniaFixture.Injector
                        .Resolve<AppBuilder>()
                        .AfterSetup(
                            _ => tcs.SetResult(SynchronizationContext.Current.ThrowIfNull())
                        )
