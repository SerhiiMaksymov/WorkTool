...
public static class Consts
{
    ...
    public static readonly IEnumerable<string> EnumerableNames = new[] { EnumerableTypeFullName };

    public static readonly IEnumerable<string> CollectionNames = new[] { CollectionTypeFullName };
