...
public static class ConnectionParametersExtension
{
    ...
    public static string GetConnectionString<TConnectionParameters>(this TConnectionParameters connectionItems)
        where TConnectionParameters : IConnectionParameters
    {
        return connectionItems.GetNoDefaultParameters().GetConnectionString();
    }

    public static string GetSafeConnectionString<TConnectionParameters>(this TConnectionParameters connectionItems)
        where TConnectionParameters : IConnectionParameters
    {
        return connectionItems.SafeParameters
            .GetNoDefaultParameters()
            .GetConnectionString();
    }
    ...
    this TConnectionParameters connection, Func<TCommand, Task> func)
        where TConnectionParameters : IConnectionParameters
        where TDbConnection : DbConnection, new()
    ...
    public static async Task<string> GetCsvStringAsync<TConnectionParameters, TDbConnection, TCommand>(
    this TConnectionParameters connection, string query)
        where TConnectionParameters : IConnectionParameters
        where TDbConnection : DbConnection, new()
        where TCommand : DbCommand, new()
    {
        await using var dDConnection = connection.ToDbConnection<TConnectionParameters, TDbConnection>();
        var             result       = await dDConnection.GetCsvStringAsync<TCommand, TDbConnection>(query);

        return result;
    }

    public static async Task<string> GetTableStringAsync<TConnectionParameters, TDbConnection, TCommand>(
    ...
    {
        await using var dDConnection = connection.ToDbConnection<TConnectionParameters, TDbConnection>();
        var result = await dDConnection.GetTableStringAsync<TCommand, TDbConnection>(query, rowSeparator, padding);

        return result;
    }

    public static async Task<DataTable> GetDataTableAsync<TConnectionParameters, TDbConnection, TCommand>(
    this TConnectionParameters connection, string query)
        where TConnectionParameters : IConnectionParameters
        where TDbConnection : DbConnection, new()
        where TCommand : DbCommand, new()
    ...
    public static async Task<DataTable> GetDataTableAsync<TConnectionParameters, TDbConnection, TCommand, TDataAdapter>(
    this TConnectionParameters connection, string query)
        where TConnectionParameters : IConnectionParameters
        where TDbConnection : DbConnection, new()
        where TCommand : DbCommand, new()
    ...
    public static DataTable GetDataTable<TConnectionParameters, TDbConnection, TCommand, TDataAdapter>(
    this TConnectionParameters connection, string query)
        where TConnectionParameters : IConnectionParameters
        where TDbConnection : DbConnection, new()
        where TCommand : DbCommand, new()
    ...
    public static async Task<int> ExecuteNonQueryAsync<TConnectionParameters, TDbConnection, TCommand>(
    this TConnectionParameters connection, string query)
        where TConnectionParameters : IConnectionParameters
        where TDbConnection : DbConnection, new()
        where TCommand : DbCommand, new()
    ...
    public static async Task<object> ExecuteScalarAsync<TConnectionParameters, TDbConnection, TCommand>(
    this TConnectionParameters connection, string query)
        where TConnectionParameters : IConnectionParameters
        where TDbConnection : DbConnection, new()
        where TCommand : DbCommand, new()
    ...
    public static async Task<object> ExecuteScalarAsync<TConnectionParameters, TDbConnection, TCommand, TParameter>(
        ...
        where TParameter : DbParameter
    {
        ...
        return await dDConnection.ExecuteScalarAsync<TCommand, TDbConnection, TParameter>(query, parameters);
    }

    public static async Task<int> ExecuteNonQueryAsync<TConnectionParameters, TDbConnection, TCommand, TParameter>(
    this TConnectionParameters connection, string query, IEnumerable<TParameter> parameters)
        where TConnectionParameters : IConnectionParameters
        where TDbConnection : DbConnection, new()
        where TCommand : DbCommand, new()
        where TParameter : DbParameter
    {
        ...
        return await dDConnection.ExecuteNonQueryAsync<TCommand, TDbConnection, TParameter>(query, parameters);
    }
