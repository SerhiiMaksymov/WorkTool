...
public class TreeNodeStringHumanizing<TKey, TValue> : IHumanizing<TreeNode<TKey, TValue>, string> where TKey : notnull
{
    ...
    public TreeNodeStringHumanizing(TreeNodeStringHumanizingOptions options, IHumanizing<TKey, string> humanizingKey,
