...
public class PropertyInfoItemsControlContextBuilder : IBuilder<PropertyInfoTemplatedControlContext>
{
    ...
    public PropertyInfoItemsControlContextBuilder SetDefaultView(Func<object, PropertyInfo, IObjectValue> match)
    {
        defaultView = match;
    ...
    public PropertyInfoItemsControlContextBuilder SetView(Type type, Func<object, PropertyInfo, IObjectValue> match)
    {
    ...
    public PropertyInfoItemsControlContextBuilder SetView<TType>(Func<object, PropertyInfo, IObjectValue> match)
    {
        return SetView(typeof(TType), match);
    }

    public static PropertyInfoItemsControlContextBuilder CreateDefaultBuilder(IResolver resolver, UiContext uiContext)
    {
        var result = new PropertyInfoItemsControlContextBuilder()
            .SetView<string>(
                (obj, property) => new StringNullablePropertyInfoTemplatedControl(
            ...
            .SetView<short>(
                (obj, property) => new Int16PropertyInfoTemplatedControl
                {
            ...
            .SetView<ushort>(
                (obj, property) => new UInt16PropertyInfoTemplatedControl
                {
            ...
            .SetView<uint>(
                (obj, property) => new UInt32PropertyInfoTemplatedControl
                {
            ...
            .SetView<ulong>(
                (obj, property) => new UInt64PropertyInfoTemplatedControl
                {
            ...
            .SetView<long>(
                (obj, property) => new Int64PropertyInfoTemplatedControl
                {
            ...
            .SetView<int>(
                (obj, property) => new Int32PropertyInfoTemplatedControl
                {
            ...
            .SetView<byte>(
                (obj, property) => new BytePropertyInfoTemplatedControl
                {
            ...
            .SetView<sbyte>(
                (obj, property) => new SBytePropertyInfoTemplatedControl
                {
            ...
            .SetView<bool>(
                (obj, property) => new BooleanPropertyInfoTemplatedControl
                {
            ...
            .SetView<double>(
                (obj, property) => new DoublePropertyInfoTemplatedControl
                {
            ...
            .SetView<decimal>(
                (obj, property) => new DecimalPropertyInfoTemplatedControl
                {
            ...
            .SetDefaultView(
                (obj, property) =>
                {
                    if (obj.GetType().IsValueType)
                    {
                        ...
                        propertyInfoItemsControl.Title        = $"{property.Name}[{property.PropertyType}]";
                    ...
                    nullablePropertyInfoItemsControl.Value        = resolver.Resolve(property.PropertyType);
                    nullablePropertyInfoItemsControl.Object       = obj;
                    nullablePropertyInfoItemsControl.PropertyInfo = property;
                    nullablePropertyInfoItemsControl.Title        = $"{property.Name}[{property.PropertyType}]";
    ...
    private static Action<PropertyInfoTemplatedControl<TValue, TextBox>, TemplateAppliedEventArgs, TextBox, TextBlock>
        SetupContextMenu<TValue>(UiContext uiContext)
    {
        return (property, _, control, _) =>
            property.GetObservable(PropertyInfoTemplatedControl<TValue, TextBox>.PropertyInfoProperty)
                .Subscribe(
                    _ =>
                    {
                        ...
                        var menuFlyout = new MenuFlyout()
                            .AddItems(control.CreateDefaultMenuItems());
                        ...
                        menuFlyout.AddItems(
                            defaultValues.Select(
                                x => new MenuItem
                                {
                                    Command = ReactiveCommand.Create(() => property.Value = (TValue)x.Value),
                                    Header  = x.Name
                                }));
                    });
    }
