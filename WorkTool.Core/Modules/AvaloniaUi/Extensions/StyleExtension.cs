...
{
    public static TStyle AddSetter<TStyle>(this TStyle style, AvaloniaProperty property, object value)
        where TStyle : Style
    {
    ...
    public static TStyle AddSetterDynamicResource<TStyle>(this TStyle style, AvaloniaProperty property,
                                                          object      resourceKey)
        where TStyle : Style
    {
