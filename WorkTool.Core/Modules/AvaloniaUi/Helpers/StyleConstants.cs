                ...
                .SetValue(
                    new FuncControlTemplate<BooleanPropertyInfoTemplatedControl>(
                        (_, name) => new Grid()
                            ...
                            .AddChild(
                                new TextBlock()
                                    .SetName(BooleanPropertyInfoTemplatedControl.ElementTextBlockName, name)
                                    .BindTemplateValue(
                            ...
                            .AddChild(
                                new CheckBox()
                                    .SetName(BooleanPropertyInfoTemplatedControl.ElementControlName, name)
                                    .SetGridColumn(1)))));
                ...
                .SetValue(
                    new FuncControlTemplate<UInt16PropertyInfoTemplatedControl>(
                        (_, name) => new Grid()
                            ...
                            .AddChild(
                                new TextBlock()
                                    .SetName(UInt16PropertyInfoTemplatedControl.ElementTextBlockName, name)
                                    .BindTemplateValue(
                                        TextBlock.TextProperty,
                            ...
                            .AddChild(
                                new NumericUpDown()
                                    .SetName(UInt16PropertyInfoTemplatedControl.ElementControlName, name)
                                    .SetGridColumn(1)))));
            ...
            new Setter()
                ...
                .SetValue(
                    new FuncControlTemplate<PropertyInfoReactiveItemsControl>(
                        (templated, nameScope) => new Expander()
                            .SetVerticalContentAlignmentStretch()
                            .SetHorizontalContentAlignmentStretch()
                            .SetHeader(
                                new TextBlock()
                                    .SetName(PropertyInfoReactiveItemsControl.ElementTextBlock, nameScope)
                                    .BindTemplateValue(
                                        TextBlock.TextProperty,
                            ...
                            .SetContent(
                                new ItemsPresenter()
                                    .SetName(PropertyInfoReactiveItemsControl.ElementItemsPresenter, nameScope)
                                    .BindTemplateValue(
                        ...
                        (templated, name) => new Expander()
                            ...
                            .SetHeader(
                                templated.CheckBox
                                    .SetContent(
                                        new TextBlock()
                                            .SetName(PropertyInfoReactiveItemsControl.ElementTextBlock)
                                            .RegisterInNameScope(name)))
                            .SetContent(
                                new ItemsPresenter()
                                    .SetName(PropertyInfoReactiveItemsControl.ElementItemsPresenter)
                                    .RegisterInNameScope(name)))));
    ...
    public static readonly IStyle StringPropertyInfoTemplatedControlStyle = new Style()
        ...
        .AddSetter(
            ...
            new FuncControlTemplate<StringNullablePropertyInfoTemplatedControl>(
                (templated, name) => new Grid()
                    .AddColumnDefinitions(GridLength.Star, GridLength.Auto, GridLength.Star)
                    .AddChild(
                        new TextBlock()
                            .SetName(StringNullablePropertyInfoTemplatedControl.ElementTextBlockName, name)
                            .BindTemplateValue(
                                TextBlock.TextProperty,
                                StringNullablePropertyInfoTemplatedControl.TitleProperty)
                            .Item)
                    ...
                    .AddChild(
                        new TextBox()
                            .SetName(StringNullablePropertyInfoTemplatedControl.ElementControlName, name)
                            .SetGridColumn(2)
                            .BindTemplateValue(
                            ...
                            .AddChild(
                                new ContentPresenter()
                                    ...
                                    .BindValue(
                                        ...
                                        new TemplateBinding(DialogControl.DialogBackgroundProperty),
                                        null)
                                    .Item
                                    .SetZIndex(2)
                                    .BindValue(
                                        Visual.IsVisibleProperty,
                                        new TemplateBinding(DialogControl.IsVisibleDialogProperty),
                                        null)
                                    .Item
                                    .BindValue(
                                        ContentPresenter.ContentProperty,
