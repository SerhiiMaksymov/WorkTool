...
public static class SqlServerConnectionParametersExtension
{
    ...
    )
    {
        ...
        return await dDConnection.ExecuteScalarAsync<SqlCommand, SqlConnection, SqlParameter>(
            query,
            parameters
        );
    }
    ...
    )
    {
        ...
        return await dDConnection.ExecuteNonQueryAsync<SqlCommand, SqlConnection, SqlParameter>(
            query,
            parameters
        );
    }
